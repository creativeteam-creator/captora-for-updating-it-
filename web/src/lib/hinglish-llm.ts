...
const PHONETIC_ENGLISH_FIXES: Record<string, string> = {
  ...
  feis: "face",
  fais: "face",
  // Common one-syllable English words mangled in Hindi speech
  laiph: "life",
  laif: "life",
  laifh: "life",
  enjoay: "enjoy",
  ...
  hops: "hopes",
  hop: "hope",
  // Longer English words ElevenLabs phonetically butchers
  koanphidentali: "confidently",
  koanphident: "confident",
  konfident: "confident",
  konfidentali: "confidently",
  confidens: "confidence",
  imprasiv: "impressive",
  pawarful: "powerful",
  pawerful: "powerful",
  bewtiful: "beautiful",
  ...
  importent: "important",
  importan: "important",
  // Mangled Hindi words (where ElevenLabs misspelt the Devanagari→Roman)
  ganjapn: "ganjapan",
  ganjepan: "ganjapan",
  karavakara: "karva kar",
  karavakar: "karva kar",
  karvaane: "karwane",
  karvana: "karwana",
  kaip: "cap",
